	...
	<div class="clearfix">
		<div class="js-stools-container-bar">
			<label for="filter_search" class="element-invisible"
				aria-invalid="false"><?php echo Text::_('COM_{{ constantCase componentName }}_SEARCH_FILTER_SUBMIT'); ?></label>

			<div class="btn-wrapper input-append">
				<?php echo $search_filter->input; ?>
				<button type="submit" class="btn hasTooltip" title=""
					data-original-title="<?php echo Text::_('COM_{{ constantCase componentName }}_SEARCH_FILTER_SUBMIT'); ?>">
			...
			if ($filters)
			{
				...
				<div class="btn-wrapper hidden-phone">
					<button type="button" class="btn hasTooltip js-stools-btn-filter" title=""
						data-original-title="<?php echo Text::_('COM_{{ constantCase componentName }}_SEARCH_TOOLS_DESC'); ?>">
						<?php echo Text::_('COM_{{ constantCase componentName }}_SEARCH_TOOLS'); ?> <i class="caret"></i>
					</button>
				</div>
				<?php
			}
			...
			<div class="btn-wrapper">
				<button type="button" class="btn hasTooltip js-stools-btn-clear" title=""
					data-original-title="<?php echo Text::_('COM_{{ constantCase componentName }}_SEARCH_FILTER_CLEAR'); ?>"
					onclick="jQuery(this).closest('form').find('input').val('');">
					<?php echo Text::_('COM_{{ constantCase componentName }}_SEARCH_FILTER_CLEAR'); ?>
				</button>
			</div>
		</div>
	</div>
